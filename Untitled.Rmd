...
prfaweitongz::crime_analysis(crime,"PROPERTY DAMAGE AND ENVIRONMENTAL",c(5022,5023))
#for (i in seq_along(crime_files)) {
  ...
  #setnames(crime[[i]], c("date", "suburb", "postcode", "offence_level_1",
      #              "offence_level_2", "offence_level_3", "offence_count"))
 # prfaweitongz::crime_analysis(crime[[i]],"PROPERTY DAMAGE AND ENVIRONMENTAL",c(5022,5023))
#}
